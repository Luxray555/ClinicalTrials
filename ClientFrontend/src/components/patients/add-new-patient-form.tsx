...
import createNewPatient from "@/actions/doctors/create-new-patient";
...
export default function AddNewPatientForm({
  ...
  setAddNewPatientOpen: React.Dispatch<React.SetStateAction<boolean>>;
}) {
  ...
  return (
    <Form {...form}>
      ...
      >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder="bilal@gmail.com" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder="+213789451220" type="text" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input placeholder="16000" type="text" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Textarea
                    placeholder="The history of the patient"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <Button type="submit">
          {isLoading ? <LoadingSpinner /> : "Add patient"}
        </Button>
      </form>
    </Form>
  );
